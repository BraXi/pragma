...
// Surface flags
//
#define	SURF_NODAMAGE			1			// never give falling damage
#define	SURF_SLICK				2			// effects game physics
#define	SURF_SKY				4			// lighting from environment map
#define	SURF_LADDER				8			// effects game physics
#define	SURF_NOIMPACT			16			// don't make missile explosions
#define	SURF_NOMARKS			32			// don't leave missile marks
#define	SURF_FLESH				64			// make flesh sounds and effects
#define	SURF_NODRAW				128			// don't generate a drawsurface at all
#define	SURF_HINT				256			// make a primary bsp splitter
#define	SURF_SKIP				512			// completely ignore, allowing non-closed brushes
#define	SURF_NOLIGHTMAP			1024		// surface doesn't need a lightmap
#define	SURF_POINTLIGHT			2048		// generate lighting info at vertexes
#define	SURF_METALSTEPS			4096		// clanking footsteps
#define	SURF_NOSTEPS			8192		// no footstep sounds
#define	SURF_NONSOLID			16384		// don't collide against curves with this set
#define SURF_LIGHTFILTER		32768		// act as a light filter during q3map -light
#define	SURF_ALPHASHADOW		65536		// do per-pixel light shadow casting in q3map
#define	SURF_NODLIGHT			131072		// don't dlight even if solid (solid lava, skies)
#define SURF_DUST				262144		// leave a dust trail when walking on this surface
