...
#define	MAX_WORLD_MODELS		0x400
#define	MAX_WORLD_BRUSHES		0x8000
#define	MAX_WORLD_ENTITIES	0x800
#define	MAX_WORLD_ENTSTRING	0x40000
#define	MAX_WORLD_SHADERS		0x400

#define	MAX_WORLD_AREAS		0x100	// MAX_WORLD_AREA_BYTES in q_shared must match!
#define	MAX_WORLD_FOGS		0x100
#define	MAX_WORLD_PLANES		0x20000
#define	MAX_WORLD_NODES		0x20000
#define	MAX_WORLD_BRUSHSIDES	0x20000
#define	MAX_WORLD_LEAFS		0x20000
#define	MAX_WORLD_LEAFFACES	0x20000
#define	MAX_WORLD_LEAFBRUSHES 0x40000
#define	MAX_WORLD_PORTALS		0x20000
#define	MAX_WORLD_LIGHTING	0x800000
#define	MAX_WORLD_LIGHTGRID	0x800000
#define	MAX_WORLD_VISIBILITY	0x200000

#define	MAX_WORLD_DRAW_SURFS	0x20000
#define	MAX_WORLD_DRAW_VERTS	0x80000
#define	MAX_WORLD_DRAW_INDEXES	0x80000

#define	BSP_LIGHTMAP_WIDTH		128
#define	BSP_LIGHTMAP_HEIGHT		128

#define BSP_MAX_WORLD_COORD		( 128*1024 )
#define BSP_MIN_WORLD_COORD		( -128*1024 )
#define BSP_WORLD_SIZE			( BSP_MAX_WORLD_COORD - BSP_MIN_WORLD_COORD )
