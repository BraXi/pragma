...
muzzleflash_t cl_muzzleflashes[FX_WEAPON_MUZZLEFLASHES] =
{
	//	forward,	right,	up,		light radius,	light color,		scale,	volume,	sound
		{44.0f,		-4.8f,	-3.5f,	200,			{1, 0.9, 0.7},		1.4f,	0.7f,	"weapons/deagle/shot.wav"}, 	// FX_MUZZLEFLASH_PISTOL
		{66.0f,		-4.8f,	-3.5f,	260,			{1, 1, 0.7},		1.0f,	0.6f,	"weapons/ak47/shot.wav"},	// FX_MUZZLEFLASH_RIFLE
